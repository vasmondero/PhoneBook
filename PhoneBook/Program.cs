...
namespace PhoneBook
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("3 Display all contacit");
            Console.WriteLine("4 Serch contacts");
            ...
            while(true)
            {
                switch (userInput)
                {
                    ...
                    case "4":
                        ...
                        var serchPhrase = Console.ReadLine();

                        phoneBook.DisplayMatchingContacts(serchPhrase);
                        break;
                    case "x":
                        return;
                    default:
